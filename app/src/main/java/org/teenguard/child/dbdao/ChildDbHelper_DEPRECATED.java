...
public class ChildDbHelper_DEPRECATED extends SQLiteOpenHelper {
    ...
    public ChildDbHelper_DEPRECATED(Context context, String name, SQLiteDatabase.CursorFactory factory, int version) {
