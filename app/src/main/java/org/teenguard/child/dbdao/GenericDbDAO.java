...
public  class GenericDbDAO {
    ...
    public GenericDbDAO() {
        SingletonDbHelper singletonDbHelper = SingletonDbHelper.getInstance(MyApp.getInstance().getApplicationContext());
        //ChildDbHelper childDbHelper = new ChildDbHelper(MyApp.getInstance().getApplicationContext(), ChildDbHelper.CHILD_DB_NAME, null, ChildDbHelper.CHILD_DB_VERSION);
