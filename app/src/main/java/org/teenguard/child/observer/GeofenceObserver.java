...
public class GeofenceObserver implements GoogleApiClient.OnConnectionFailedListener, GoogleApiClient.ConnectionCallbacks, LocationListener {
    ...
    private  void populateGeofenceAL() {
       Geofence geofence = new Geofence.Builder()
               ...
               .setCircularRegion(28.120483,-16.7775494,100)
    ...
    private PendingIntent getGeofencePendingIntent() {
        Intent intent = new Intent(MyApp.getContext(),GeofenceObserver.class);
